...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三处：DashPathEffect
        DashPathEffect dashPathEffect = new DashPathEffect(new float[]{20, 8, 4, 8}, 1);
        ...
        PathEffect pathEffect = new PathDashPathEffect(path1, 12, 1, PathDashPathEffect.Style.ROTATE);
